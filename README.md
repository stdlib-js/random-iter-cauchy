...
```javascript
iterator = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-iter-cauchy@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/random-iter-cauchy/tags). For example,

```javascript
iterator = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-iter-cauchy@v0.1.0-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var iterator = require( 'path/to/vendor/umd/random-iter-cauchy/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/random-iter-cauchy@umd/browser.js"></script>
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/random-iter-cauchy.svg
[npm-url]: https://npmjs.org/package/@stdlib/random-iter-cauchy

[test-image]: https://github.com/stdlib-js/random-iter-cauchy/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/random-iter-cauchy/actions/workflows/test.yml?query=branch:v0.1.0

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/random-iter-cauchy/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/random-iter-cauchy?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/random-iter-cauchy.svg
[dependencies-url]: https://david-dm.org/stdlib-js/random-iter-cauchy/main
...
[branches-url]: https://github.com/stdlib-js/random-iter-cauchy/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/random-iter-cauchy/main/LICENSE
