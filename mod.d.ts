...
/**
* Interface for iterators of pseudorandom numbers drawn from a Cauchy distribution.
*/
...
* // ...
*/
declare function iterator( x0: number, gamma: number, options?: Options ): RandIter; // tslint:disable-line:max-line-length
